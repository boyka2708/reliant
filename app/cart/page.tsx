    ...
    <div>
      {cart.length > 0 ? (
        <div className="mt-10">
          ...
          <Link href="/checkout">
            <p className="text-white bg-blue-500 p-2 w-24 text-center rounded-md my-10 border mx-auto">
              Checkout
            </p>
          </Link>
        </div>
        ...
        <div className="flex flex-col justify-center items-center h-[50vh]">
          ...
          <Link href="/shop">
            <button className="border p-1 text-white rounded-sm mt-5 bg-blue-500">
              Return To Shop
            </button>
          </Link>
        </div>
